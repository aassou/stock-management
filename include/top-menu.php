<div class="navbar-inner">
	<div class="container-fluid">
        ...
        //obj and vars
        //$taskNumber = $taskManager->getTaskNumberByUser($_SESSION['userstock']->login());
        //$bugNumber = $bugManager->getBugsNumber();
        //$alertNumber = $alertManager->getAlertsNumber();
        //$todoNumber = $todoManager->getTodosNumberByUser($_SESSION['userstock']->login());
		?>			
		<ul class="nav pull-right">
			...
			<li class="dropdown user">
				...
				<span class="username"><?= $_SESSION['userstock']->login(); ?></span>
