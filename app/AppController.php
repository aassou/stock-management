...
class AppController{
    ...
    public function add($formInputs){
        ...
        else if ( $this->_validation->validate($formInputs, $this->_action) == ValidationController::EXIST ) {
            $this->_actionMessage = $this->_validation->getMessage();    
            $this->_typeMessage = "success";
            $this->_source = $this->_validation->getTarget();
        } 
        //Else throw an error
        else if ( $this->_validation->validate($formInputs, $this->_action) == ValidationController::NOT_VALID ) {
            $this->_actionMessage = $this->_validation->getMessage();  
