...
class ValidationController {
    ...
    public function validate($formInputs, $action) {
        ...
        elseif ( $this->_source == "client" ){
        ...
        } elseif ( $this->_source == "tranche" ) {
            $projectId = $formInputs['idProjet'];
            $this->_target = "tranche.php?projectId=$projectId";

            if($action == "add") {
                if (!empty($formInputs['idProjet']) and
                    !empty($formInputs['name'])
                ) {
                    $this->_message = "<strong>Opération Valide : </strong>TRANCHE ajouté(e) avec succès.";

                    return self::VALID;
                } else {
                    $this->_message = "<strong>Erreur Création TRANCHE : </strong>Vous devez remplir tous les champs obligatoires : <sup>*</sup> correctement.";
                ...
                if (!empty($formInputs['idProjet']) and
                    ...
                    $this->_message = "<strong>Opération Valide : </strong>TRANCHE modifié(e) avec succès.";
                ...
                if (!empty($formInputs['id'])) {
                    $this->_message = "<strong>Opération Valide : </strong>TRANCHE supprimé(e) avec succès.";

                    return self::VALID;
                } else {
                    $this->_message = "<strong>Erreur suppression TRANCHE : </strong>Le champs idProjet est inexistant.";

                    return self::NOT_VALID;
                }
            }
        } elseif ( $this->_source == "bloc" ) {
            $projectId = $formInputs['idProjet'];
            $this->_target = "tranche.php?projectId=$projectId";
            ...
            if($action == "add") {
                if (!empty($formInputs['idProjet']) and
                    ...
                    $this->_message = "<strong>Opération Valide : </strong>BLOC ajouté(e) avec succès.";

                    return self::VALID;
                } else {
                    $this->_message = "<strong>Erreur Création BLOC : </strong>Vous devez remplir tous les champs obligatoires : <sup>*</sup> correctement.";

                    return self::NOT_VALID;
                }
            } elseif ($action == "update") {
                if (!empty($formInputs['id']) and
                    !empty($formInputs['idProjet']) and
                    !empty($formInputs['name'])
                ) {
                    $this->_message = "<strong>Opération Valide : </strong>BLOC modifié(e) avec succès.";
                ...
                if (!empty($formInputs['id'])) {
                    $this->_message = "<strong>Opération Valide : </strong>BLOC supprimé(e) avec succès.";

                    return self::VALID;
                } else {
                    $this->_message = "<strong>Erreur suppression BLOC : </strong>Le champs idProjet est inexistant.";
