...
<body class="fixed-top">
    ...
    <div class="header navbar navbar-inverse navbar-fixed-top">
        ...
        $myTasks = $taskManager->getTasksByUser($_SESSION['userstock']->login());
        $tasksAffectedByMeToOther = 
        $taskManager->getTasksAffectedByMeToOther($_SESSION['userstock']->login());
        ?>   
                                                            ...
                                                            <div class="controls">
                                                                <select name="user" id="user">
                                                                    ...
                                                                    foreach ( $users as $user ) {
                                                                        if ( $user->login() != $_SESSION['userstock']->login() ) {
                                                                    ?>
                            ...
                            <div class="portlet-body" id="chats">
                                ...
                                <div class="scroller" data-height="500px" data-always-visible="1" id="messages" data-rail-visible1="1">
                                            ...
                                            <form class="form-horizontal" action="" method="post">
                                                <div class="control-group">
                                                    <div class="controls">  
                                                        ...
                                                        <input type="hidden" name="user" value="<?= $_SESSION['userstock']->login() ?>" />
                                                        <button class="btn" data-dismiss="modal"aria-hidden="true">Non</button>
                                    ...
                                    <ul class="chats">
                                        ...
                                        if($task->createdBy() == $_SESSION['userstock']->login()){
                                            $classInOrOut = "in";
