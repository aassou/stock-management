...
//classes loading begin
    ...
    and ($_SESSION['userstock']->profil() == "admin" OR $_SESSION['userstock']->profil() == "consultant") ){
        //classManagers
                    ...
                    <div class="span12">
                        ...
                        <div class="row-fluid">
                            <div class="input-box autocomplet_container">
                                ...
                                <?php 
                                if ( $_SESSION['userstock']->profil() == "admin" ) {
                                ?>
...
else if ( isset($_SESSION['userstock']) and $_SESSION['userstock']->profil() != "admin" ) {
