                                    ...
                                    <div class="row-fluid">
                                       <div class="span3 ">
                                          <div class="control-group">
                                             ...
                                             <div class="controls">
                                                <input disabled="disabled" type="text" id="login" name="login" class="m-wrap span12" value="<?= $_SESSION['userstock']->login() ?>">
                                             </div>
                                          </div>
                                       </div>
                                       <div class="span3 ">
                                          <div class="control-group">
                                             ...
                                             <div class="controls">
                                                <input disabled="disabled" type="text" id="profil" name="profil" class="m-wrap span12" value="<?= $_SESSION['userstock']->profil() ?>">
                                             </div>
                                          </div>
                                       </div>
                                       <!--/span-->
                                       ...
                                       <div class="span3 ">
                                          <div class="control-group">
                                             ...
                                             <div class="controls">
                                                <input disabled="disabled" type="text" id="dateCreation" name="dateCreation" class="m-wrap span12" value="<?= date('Y-m-d', strtotime($_SESSION['userstock']->created())) ?>">
                                             </div>
                                          </div>
                                       </div>
                                    </div>
