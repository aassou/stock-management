...
if( isset($_SESSION['userstock']) ){
    ...
    $breadcrumb = new Breadcrumb([
        [
            'class' => 'icon-money',
            'link' => 'caisse-group.php',
            'title' => '<strong>La Caisse</strong>'
        ],
        [
            'class' => '',
            'link' => '',
            'title' => '<strong>' . $mois . '/' . $annee . '</strong>'
        ]
    ]);
?>
<!DOCTYPE html>
