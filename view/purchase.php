                                ...
                                <form class="form-horizontal" action="../app/Dispatcher.php" method="post">
                                    <div class="modal-body">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input required="required" type="text" name="client" class="m-wrap span12" />
                                            </div>
                                        </div>
                                        <div class="control-group">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="hidden-phone">
                                                    <a href="SaleDetail.php?codeSale=<?= $purchase->getCode() ?>" class="btn mini blue" title="Voir Détail Vente">
